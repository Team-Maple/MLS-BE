...
class MapRecommendationObservabilityTest {

    @Test
    void exposesOnlyBoundedEngineApiVersionAndOutcomeTags() {
        SimpleMeterRegistry registry = new SimpleMeterRegistry();
        MapRecommendationObservability observability = new MapRecommendationObservability(registry);
        ...
        assertThat(registry.get(MapRecommendationObservability.REQUESTS_METRIC)
        ...
        assertThat(registry.get(MapRecommendationObservability.REQUESTS_METRIC)
                ...
                .counter().count()).isEqualTo(1.0d);
        assertThat(registry.get(MapRecommendationObservability.RESULTS_METRIC)
