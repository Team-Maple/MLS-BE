...
class MapRecommendationEnrichmentServiceTest {
    ...
    private final MapRecommendationEnrichmentService service =
            new MapRecommendationEnrichmentService(mapRepository, bookmarkFlagService);
    ...
    void bulkLoadsMapsAndBookmarksOnceAndPreservesScoreOrder() {
        ...
        assertThat(result).extracting(MapRecommendationResultDto::mapId)
                .containsExactly(200, 100);
        assertThat(result).extracting(MapRecommendationResultDto::bookmarkId)
